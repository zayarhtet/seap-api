...
type Duty struct {
	...
	PublishingDate     time.Time   `json:"publishedAt" binding:"required"`
	DeadlineDate       time.Time   `json:"dueDate" binding:"required"`
	ClosingDate        time.Time   `json:"closingDate" binding:"required"`
